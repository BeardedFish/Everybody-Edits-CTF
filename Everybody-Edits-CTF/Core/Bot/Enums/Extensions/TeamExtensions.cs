...
namespace Everybody_Edits_CTF.Core.Bot.Enums.Extensions
{
    ...
    {
        /// <summary>
        /// Gets the opposite team from a <see cref="Team"/> enum.
        /// </summary>
        /// <param name="team">The <see cref="Team"/> enum to get the opposite of.</param>
        /// <returns>
        ...
        /// </summary>
        /// <param name="team">The <see cref="Team"/> enum to be converted to a human readable string.</param>
